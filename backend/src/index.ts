...
async function initData() {
    ...
    await createAndPersistData("Julien", "Description de l'annonce Bordeaux 1", "Auteur 1", 1.0, new Date(), "https://placebear.com/200/351.jpg", "Bordeaux", cat3, tag, tag3),
        await createAndPersistData("Marie", "Description de l'annonce Bordeaux 2", "Auteur 2", 15.0, new Date(), "https://placebear.com/200/352.jpg", "Bordeaux", cat10, tag),
        ...
        await createAndPersistData("Camille", "Description de l'annonce Bordeaux 4", "Auteur 4", 25.0, new Date(), "https://placebear.com/200/354.jpg", "Bordeaux", cat4, tag, tag3),
        await createAndPersistData("Paul", "Description de l'annonce Bordeaux 5", "Auteur 5", 3.0, new Date(), "https://placebear.com/200/355.jpg", "Bordeaux", cat5, tag, tag2),
        await createAndPersistData("Julie", "Description de l'annonce Bordeaux 6", "Auteur 6", 35.0, new Date(), "https://placebear.com/200/356.jpg", "Bordeaux", cat6, tag),
        await createAndPersistData("Thomas", "Description de l'annonce Bordeaux 7", "Auteur 7", 4.0, new Date(), "https://placebear.com/200/357.jpg", "Bordeaux", cat10, tag, tag3),
        await createAndPersistData("Alexandre", "Description de l'annonce Bordeaux 9", "Auteur 9", 5.0, new Date(), "https://placebear.com/200/359.jpg", "Bordeaux", cat9, tag, tag2),
        await createAndPersistData("Claire", "Description de l'annonce Bordeaux 10", "Auteur 10", 55.0, new Date(), "https://placebear.com/200/310.jpg", "Bordeaux", cat, tag, tag3),
        ...
        await createAndPersistData("Emilie", "Description de l'annonce Bordeaux 14", "Auteur 14", 75.0, new Date(), "https://placebear.com/200/314.jpg", "Bordeaux", cat5, tag),
        ...
        await createAndPersistData("Milo", "Description de l'annonce Bordeaux 8", "Auteur 8", 45.0, new Date(), "https://placebear.com/200/358.jpg", "Bordeaux", cat10, tag),
        await createAndPersistData("Isabelle", "Description de l'annonce Bordeaux 16", "Auteur 16", 85.0, new Date(), "https://placebear.com/200/316.jpg", "Bordeaux", cat2, tag, tag3),
        ...
        await createAndPersistData("Matthieu", "Description de l'annonce Paris 7", "Auteur 27", 14.0, new Date(), "https://placebear.com/200/327.jpg", "Paris", cat4, tag),
        await createAndPersistData("Aline", "Description de l'annonce Paris 8", "Auteur 28", 145.0, new Date(), "https://placebear.com/200/328.jpg", "Paris", cat5, tag, tag2),
        await createAndPersistData("Benoît", "Description de l'annonce Paris 9", "Auteur 29", 15.0, new Date(), "https://placebear.com/200/329.jpg", "Paris", cat6, tag),
        await createAndPersistData("Céline", "Description de l'annonce Paris 10", "Auteur 30", 155.0, new Date(), "https://placebear.com/200/330.jpg", "Paris", cat7, tag),
        await createAndPersistData("Quentin", "Description de l'annonce Paris 11", "Auteur 31", 16.0, new Date(), "https://placebear.com/200/331.jpg", "Paris", cat8, tag, tag2),
        await createAndPersistData("Laura", "Description de l'annonce Paris 12", "Auteur 32", 165.0, new Date(), "https://placebear.com/200/332.jpg", "Paris", cat9, tag),
        ...
        // Lyon
        await createAndPersistData("Léa", "Description de l'annonce Lyon 1", "Auteur 41", 21.0, new Date(), "https://placebear.com/200/341.jpg", "Lyon", cat4, tag),
        await createAndPersistData("Lucas", "Description de l'annonce Lyon 2", "Auteur 42", 215.0, new Date(), "https://placebear.com/200/342.jpg", "Lyon", cat5, tag, tag2),
        await createAndPersistData("Emma", "Description de l'annonce Lyon 3", "Auteur 43", 22.0, new Date(), "https://placebear.com/200/343.jpg", "Lyon", cat6, tag, tag2),
        ...
        await createAndPersistData("Robin", "Description de l'annonce Lyon 8", "Auteur 48", 245.0, new Date(), "https://placebear.com/200/348.jpg", "Lyon", cat10, tag, tag3),
